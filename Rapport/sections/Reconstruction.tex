...
\fxnote{write a subsection about why these methods have been chosen for gap fixing in the SmartHG data. }

\section{Gaps In SmartHG Dataset}
The gaps in the SmartHG project dataset is caused by a lot of different sources. This makes the type of gaps different from case to case. Three aspects of a gap is important for the gap filling: The size of the gap, the data known before the gap, and the data known after the gap. \fxnote{give examples of what can cause the gaps. }
...
\fxnote{Units is missing the the graphs, and how is this plots created. Give a more detailed explanation and discussion. }
...
\fxnote{The units is not understandable and needs explained.}

\fxnote{ A bit more discussion about what the purpose of this information is.}
...
\fxnote{ Gap fixing på SmartHG dataen. }
