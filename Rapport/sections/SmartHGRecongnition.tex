...
An other metric looks at the ratio between the number of appliances in the statistical disaggregation model and the \df{complexity}. This ratio is called the \df{completeness} of the model, since it indicate how many of the total appliances that are include in the model.
