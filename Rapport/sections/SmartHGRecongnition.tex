...
On figure \ref{fig:Norm1} is the disaggregation of TV 1 from house 10 shown for a one day period. The blue line indicate the \ab{FHMM} algorithms suggestions on when the TV are on and off. The green line is the actual on and off periods, collected from the sub-meters. 
